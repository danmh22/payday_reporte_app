                            ...
                            <tbody class="divide-y divide-gray-100 border-t border-gray-100 text-xs">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        <p class="font-bold flex justify-start items-center text-slate-500 pr-4 text-xs">≈ {{ number_format($facturasC->monto_actual_bs, 2) }} <span class="text-cyan-800 text-xxs ml-1">Bs</span></p>
                                    </td>
                                    <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-end relative gap-4" x-data="{ open: false }">
                                        ...
                                        class="absolute bg-white z-50 mt-2 w-32 rounded-md shadow-lg right-full p-1">
                                                <li><a class="p-2 block text-xs font-bold hover:text-emerald-700 hover:bg-emerald-50" href="{{ route('factura', $facturasC) }}">Ver Factura</a></li>
                                        </ul>
                                    </div>
                                </td>
                                </tr>
                ...
                @else
                    ...
                    <div class="p-5">
                        <div class="w-full flex flex-col flex-wrap text-center justify-center items-center">
                            ...
                            <p class="text-sm font-bold text-neutral-500 w-2/3">Parece que tienes facturas por conciliar o aún no has recibido facturas del administrador</p>
                        </div>
                    </div>
