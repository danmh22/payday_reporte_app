                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-end relative gap-4" x-data="{ open: false }">
                                        ...
                                        class="absolute bg-white z-50 mt-2 w-32 rounded-md shadow-lg right-full p-1">
                                                <li><a class="p-2 block text-xs font-bold hover:text-blue-500 hover:bg-blue-50" href="{{ route('factura', $facturasP) }}">Ver Factura</a></li>
                                                <li><a class="p-2 block text-xs font-bold hover:text-blue-500 hover:bg-blue-50" href="{{ route('reportar-pago', $facturasP) }}">Reportar Pago</a></li>
                                        </ul>
                                    </div>
                                </td>
                                </tr>
