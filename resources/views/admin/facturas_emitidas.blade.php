                    ...
                    <div class="overflow-x-auto rounded shadow border-gray-200">
                        <div class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-100 border-t border-gray-100 text-xs">
                                ...
                                <td class="px-4 py-3">
                                    <p class="font-bold flex justify-start items-center text-emerald-600 pr-4 text-base">{{ $factura->monto_deudor }} <span class="text-emerald-700 text-xxs ml-2">USD</span></p>
                                </td>
                                <td class="px-4 py-3">
                ...
                @else
                    ...
                    <div class="p-5">
                        <div class="w-full flex flex-col flex-wrap text-center justify-center items-center">
                            ...
                            <p class="text-sm w-1/2 font-bold text-neutral-500">Puede que aún no hayas cargado facturas para tus aliados comerciales. Prueba <a class="text-emerald-600" href="{{ route('cargar-facturas') }}">cargar facturas</a>.</p>
                        </div>
                    </div>
