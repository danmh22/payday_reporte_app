    ...
    <div class="flex flex-wrap mx-auto py-4 pt-0">
                ...
                <div class="rounded border bg-white p-6">
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <form action="{{ route('importar-facturas') }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap w-full">
                            ...
                            <button type="submit" class="px-3 py-2 text-sm !bg-blue-700 rounded block text-white ml-4 w-1/4 font-bold">Cargar Aliado</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full sm:w-2/6 py-4 sm:px-4 lg:px-4">
            <div class="bg-gradient-to-r from-blue-500 to-blue-700 py-7 px-7 text-white rounded">
                ...
                <a href="{{ asset('downloadable/formato_carga_aliados.xlsx') }}" download="Formato para carga de aliados" class="px-3 py-2 text-center text-sm bg-white rounded block text-blue-500 w-full font-bold">Descargar formato</a>
            </div>
        </div>
    </div>
</main>
