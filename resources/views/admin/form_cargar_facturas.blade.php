...
<main>
    <div class="flex flex-wrap mx-auto py-4 pt-0">
                ...
                <div class="rounded shadow bg-white p-6">
                    ...
                    <div class="flex items-center mt-2">
                        <form action="{{ route('importar-facturas') }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap w-full">
                            ...
                            <button type="submit" class="px-3 py-2 text-sm bg-emerald-700 transition-all hover:bg-emerald-600 rounded block text-white ml-4 w-1/4 font-bold">Cargar Facturas</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full sm:w-2/6 py-4 sm:px-4 lg:px-4">
            <div class="shadow bg-gradient-to-r from-emerald-700 to-emerald-700 py-7 px-7 text-white rounded">
                <div class="flex flex-wrap">
                    <div class="w-1/6">
                        <span class="flex justify-center items-center h-8 w-8 bg-white text-emerald-700 rounded-full p-2 mb-2">
                ...
                <a href="{{ asset('downloadable/formato_carga_facturas.xlsx') }}" download="Formato para carga de Facturas" class="px-3 py-2 text-center text-sm bg-white transition-all hover:bg-emerald-600 hover:text-white rounded block text-emerald-700 w-full font-bold">Descargar formato</a>
            </div>
        </div>
    </div>
</main>
