                            ...
                            <table class="w-full border-collapse bg-white text-left text-xs text-gray-500">
                                ...
                                <tbody class="divide-y divide-gray-100 border-t border-gray-100 text-xs">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <th class="px-4 gap-3">
                                            <div class="w-8 h-8 text-green-500"><span class="material-symbols-outlined">payments</span></div>
                                        </td>
                                        </th>
                                        ...
                                        <td class="px-4 py-3 max-w-[150px]">
                                            <p class="font-bold flex justify-start items-center text-green-500 pr-4 text-base">{{ $pago->monto_equivalente }} <span class="text-green-600 text-xxs ml-2">USD</span></p>
                                        </td>
                                        <td class="px-4 py-3">
